...
const addCart = () => {
    if (skuObj.skuId) {
        // 规格已经选择   触发  action
        // action   传递商品参数
        // 调用 action  把完整的商品参数往外传
        // 共八项商品数据
        cartStore.addCart({
            id: goods.value.id,  // 商品 id
        ...
        <div class="container" v-if="goods.details">
            ...
            <div class="bread-container">
                <el-breadcrumb separator=">">
                    ...
                    <!-- 
                        错误原因：goods  开始 {}  是空  那么  {} -> {}.categories  -> undefined   ->  undefined[1]
                          a. 可选链写法  ?.
                          b. v-if   手动控制渲染时机  保证只有数据存在才渲染
                     -->
